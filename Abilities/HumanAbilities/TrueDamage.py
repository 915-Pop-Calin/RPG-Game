...
class TrueDamage(Ability):
    ...
    def cast(self, caster, opponent, list_of_turns, turn_counter):
        """
        The armour penetration of the caster is set to 75% for 3 turns and we add to the list of abilities to decast the decast
        method of this ability.
        """
    ...
    def decast(self, caster, opponent):
        """
        Everything is set back to normal for the caster.
        """
